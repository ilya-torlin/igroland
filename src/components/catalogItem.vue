      ...
      <div class="catalog-list-i">
        <div class="catalog-h">
          <div class="title-cat">
            ...
            <div class="title">
              <router-link class="" to="/catalogconfig">
                <div class="txt-link">
                  {{catalogName}}
                </div>
              </router-link>
          ...
          <div class="conf-panel">
            ...
            <div class="item">
              <button data-toggle="tooltip" data-placement="top" data-original-title="Выключить">
                <div class="svg-c">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink"
              ...
              <div class="col-md-2">
                <div class="item-b">
                  <div class=" upload-btn">
                    <button type="button" class="btn btn-outline-secondary">Скопировать</button>
