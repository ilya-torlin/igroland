...
<template>
  ...
  <!--todocomplete: API - блокировка пользователя
      todocomplete: API - список незаблокированных пользователей
      todocomplete: API - список всех пользователей (заблокированные и активные)
      todocomplete: API - список активных пользователей
      todocomplete: API - поиск пользователей по подстроке
  -->
